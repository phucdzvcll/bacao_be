...
public class ChangeSeatHandler extends BaseHandler<ChangeSeatPayload> {
    ...
    @Override
    public void onData(SocketIOClient client, ChangeSeatPayload changeSeatPayload, AckRequest ackRequest, String userId) {
        RoomDto roomDto = roomService.changeSeatService(changeSeatPayload.getRoomId(), userId, changeSeatPayload.getSeatNum());
        ...
        client.getNamespace()
                .getRoomOperations(roomDto.getRoomName())
