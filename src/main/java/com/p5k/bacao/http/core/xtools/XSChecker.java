...
import com.p5k.bacao.http.core.exception.SocketException;
...
@UtilityClass
public class XSChecker {

    public static void isTrueThruMsg(boolean isTrue, String message, SocketIOClient client) {
        if (isTrue) {
            throw new SocketException(HttpStatus.INTERNAL_SERVER_ERROR.value(), message, client);
        }
    }

    public static void isTrueThruMsg(boolean isTrue, ServiceCodeEnum serviceCodeEnum, SocketIOClient client) {
        if (isTrue) {
            throw new SocketException(serviceCodeEnum, client);
        }
    }

    public static void isFalseThruMsg(boolean isFalse, String message, SocketIOClient client) {
        if (!isFalse) {
            throw new SocketException(HttpStatus.INTERNAL_SERVER_ERROR.value(), message, client);
        }
    }

    public static void isFalseThruMsg(boolean isFalse, ServiceCodeEnum responseCodeEnum, SocketIOClient client) {
        if (!isFalse) {
            throw new SocketException(responseCodeEnum, client);
        }
    }
    ...
    public static void isEmptyThruMsg(Collection<?> coll, SocketIOClient client) {
        isEmptyThruMsg(coll, "Collection is Empty", client);
    }

    public static void isEmptyThruMsg(Collection<?> coll, String message, SocketIOClient client) {
        isTrueThruMsg(isEmpty(coll), message, client);
    }
    ...
    public static void isEmptyThruMsg(Object[] objects, SocketIOClient client) {
        isEmptyThruMsg(objects, "Object is Empty",client);
    }

    public static void isEmptyThruMsg(Object[] objects, String message, SocketIOClient client) {
        isTrueThruMsg(isEmpty(objects), message, client);
    }
    ...
    public static void isEmptyThruMsg(Map<?, ?> map, SocketIOClient client) {
        isEmptyThruMsg(map, "Map is Empty", client);
    }

    public static void isEmptyThruMsg(Map<?, ?> map, String message, SocketIOClient client) {
        isTrueThruMsg(isEmpty(map), message, client);
    }
    ...
    public static void isEmptyThruMsg(String str, SocketIOClient client) {
        isEmptyThruMsg(str, "Object is Empty", client);
    }

    public static void isEmptyThruMsg(String str, String message, SocketIOClient client) {
        isTrueThruMsg(isEmpty(str), message, client);
    }

    public static void isEmptyThruMsg(String str, ServiceCodeEnum serviceCodeEnum, SocketIOClient client) {
        isTrueThruMsg(isEmpty(str), serviceCodeEnum, client);
    }

    public static void isEmptyThruMsg(ServiceCodeEnum serviceCodeEnum, SocketIOClient client, String... strs) {
        isEmptyThruMsg(strs, client);
        for (String str : strs) {
            isTrueThruMsg(isEmpty(str), serviceCodeEnum, client);
        }
    ...
    public static void isEmptyThruMsg(@Nullable Object obj, SocketIOClient client) {
        isEmptyThruMsg(obj, "Object is Empty", client);
    }

    public static void isEmptyThruMsg(@Nullable Object obj, String message, SocketIOClient client) {
        isTrueThruMsg(isEmpty(obj), message, client);
    }
    ...
    public static void isNullThruMsg(@Nullable Object object, SocketIOClient client) {
        isNullThruMsg(object, "Object is Null", client);
    }

    public static void isNullThruMsg(@Nullable Object object, String message, SocketIOClient client) {
        isTrueThruMsg(isNull(object), message, client);
    }

    public static void isNullThruMsg(@Nullable Object object, ServiceCodeEnum serviceCodeEnum, SocketIOClient client) {
        isTrueThruMsg(isNull(object), serviceCodeEnum, client);
    }
    ...
    public static void isBlankThruMsg(@Nullable final CharSequence cs, SocketIOClient client) {
        isBlankThruMsg(cs, "Object is Blank", client);
    }

    public static void isBlankThruMsg(@Nullable final CharSequence cs, String message, SocketIOClient client) {
        isTrueThruMsg(isBlank(cs), message, client);
    }
    ...
    public static void isAnyBlankThruMsg(String message, SocketIOClient client, final CharSequence... css) {
        isTrueThruMsg(isAnyBlank(css), message, client);
    }
    ...
    public static void isAnyEmptyThruMsg(String message, SocketIOClient client, final CharSequence... css) {
        isTrueThruMsg(isAnyEmpty(css), message, client);
    }
    ...
    public static void isOverSizeThruMsg(String obj, int size, String message, SocketIOClient client) {
        isTrueThruMsg(isOverSize(obj, size), message, client);
    }
    ...
    public static void isOverSizeThruMsg(int obj, int size, String message, SocketIOClient client) {
        isTrueThruMsg(isOverSize(obj, size), message, client);
    }
